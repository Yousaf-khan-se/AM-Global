...
const Signup = () => {
    ...
    return (
        <div>
            <section className='relative bg-white/10 flex flex-col justify-around items-center md:h-[150vh] h-auto py-20'>
                <div className='absolute md:top-5 md:h-[140vh] z-10'><img src={bg} alt="" className="w-full h-full object-cover" /></div>
                ...
                <div className='shadow-2xl shadow-black/5 md:p-10 p-3 rounded-xl flex md:flex-row flex-col-reverse justify-center items-center bg-[#272727] m-2 gap-3 md:gap-10 w-auto md:w-[80vw] h-auto md:h-[100vh] z-10'>
                    <form onSubmit={handleSubmit} className='md:ml-10 md:w-[38vw] md:h-full'>
                        ...
                        <div className="flex flex-col md:flex-row justify-start items-start md:items-center gap-3 mt-6">
                            <button
                                type='submit'
                                disabled={loading}
                            ...
                            <p className="text-xs text-white/70">
                                Already have an account? <Link to="/login" className={`text-[#D5BB54] hover:underline ${loading ? 'pointer-events-none opacity-50' : ''}`}>Login here</Link>
                            </p>
                        </div>
                    </form>
                    <div className='m-3'>
                        <img src={signupPic} alt="People working together" className='h-full max-h-[92vh] object-contain' />
                    </div>
                </div>
            </section>
        </div>
