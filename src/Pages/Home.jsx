    ...
    return (
        <div className="w-full overflow-x-hidden">
            ...
            <section className='w-full bg-gray-900 py-8 lg:py-7 mobile-full-width'>
                ...
                <div className='block lg:hidden w-full px-4'>
                    ...
                    <div className='mb-12 text-center relative'>
                        <div className='relative inline-block'>
                            ...
                            <h1 className='absolute top-8 left-1/2 transform -translate-x-1/2 -rotate-[17.13deg] text-xs font-bold bg-black p-2 px-4 z-10 whitespace-nowrap'>Job Seeker</h1>
                    ...
                    <div className='text-center relative'>
                        <div className='relative inline-block'>
                            ...
                            <h1 className='absolute top-8 left-1/2 transform -translate-x-1/2 rotate-[17.13deg] text-xs font-bold bg-gradient-to-r from-themeY/60 to-themeYDark/90 bg-themeYDark p-2 px-4 z-10 rounded whitespace-nowrap'>Companies</h1>
                            {/* Content overlaid on image */}
                            <div className='absolute inset-0 flex flex-col justify-center items-center pt-16 px-4'>
                                <div className='space-y-3 text-center'>
                ...
                <div className='hidden lg:flex lg:relative lg:flex-row lg:items-center lg:justify-center lg:min-h-0 lg:pb-7'>
                    ...
                    <div className='flex items-top justify-center relative w-auto'>
                        ...
                        <h1 className='absolute text-sm font-bold bg-gradient-to-r from-themeY/60 to-themeYDark/90 bg-themeYDark p-2 pr-7 pl-7 transform rotate-[17.13deg] top-[7.6rem] right-[8.2rem] z-10 rounded'>Companies</h1>
                        <div className='absolute mt-36'>
            ...
            {/* sec1 */}
            <section
                className="bg-cover bg-center h-auto w-full pb-20 lg:pb-40 pt-10 lg:pt-0 flex flex-col items-center justify-evenly px-4 lg:px-0 mobile-full-width"
                style={{ backgroundImage: `url(${homeSection1Pattern})` }}
            >
                <div className='m-8 lg:m-16 mb-16 lg:mb-32 text-center'>
                    <h1 className='text-themeYDark/85 text-lg sm:text-xl lg:text-[2rem] font-semibold p-2'>Features</h1>
                    <h2 className='text-xl sm:text-2xl lg:text-[2.4rem] text-white font-semibold p-2 pb-0'>Why Partner With Us</h2>
                </div>
                <div className='flex flex-col lg:flex-row lg:flex-wrap justify-center items-center gap-6 lg:gap-4 xl:gap-6 w-full max-w-5xl lg:max-w-4xl xl:max-w-5xl'>
            ...
            {/* sec2 */}
            <section className='mb-8 lg:mb-16 mt-16 lg:mt-[7.1rem] px-4 lg:px-0 w-full mobile-full-width'>
                <div className='h-auto flex flex-col gap-y-8 lg:gap-y-10 justify-center content-center lg:flex-row'>
                    ...
                    <div className='flex-1 mt-4 lg:mt-[4.3rem] px-0'>
                        <h1 className='text-themeYTwo/85 p-2 text-center lg:text-left text-base lg:text-[1.12rem] mb-1'>HR Simplified</h1>
                        <h2 className='font-bold text-lg lg:text-4xl p-1 mr-4 lg:mr-20 text-center lg:text-left leading-tight lg:leading-[3.1rem]'>Outsourcing your HR needs has never been easier!</h2>
                        <div className='text-center lg:text-left mt-6'>
                            <div className='border-l-2 border-[#CEB551] ml-0 lg:ml-2 pl-4 lg:pl-0'>
                                <p className='pl-0 lg:pl-7 mb-6 lg:mb-8 mt-4 text-sm -tracking-tighter font-[180] text-balance'><span className='text-sm font-normal'>A M Global</span> is the leading provider of HR outsourcing services, and we provide a comprehensive suite of services that allow businesses to focus on their core competencies and leave the HR functions to us.</p>
                                <p className='pl-0 lg:pl-7 text-sm lg:text-base leading-5 text-balance'>Partner with us for streamlined HR management, ensuring your business thrives without the administrative burden.</p>
                            </div>
                        </div>
                        ...
                        <div className='flex justify-center lg:justify-start pl-0 lg:pl-8 mt-8 lg:mt-[6rem]'>
            ...
            <section className='bg-white/[0.13] h-auto flex flex-col justify-center items-center pt-8 lg:pt-14 pb-16 lg:pb-32 px-4 lg:px-0 lg:ml-4 w-full'>
                <div className='pt-10 lg:pt-20 pb-16 lg:pb-36 lg:pl-28 self-center lg:self-start max-w-lg text-center lg:text-left'>
                    <h1 className='font-bold text-2xl lg:text-3xl xl:text-[2.3rem] pb-4'>Our Services</h1>
                ...
                <div className='flex flex-wrap gap-4 lg:gap-6 justify-center items-center max-w-6xl'>
            ...
            >
                ...
                <div className='p-6 lg:p-14 text-center'>
                    <h1 className='text-2xl lg:text-4xl font-semibold p-3'>Our Office</h1>
                    <p className='text-lg lg:text-2xl font-light'>Find us at our offices in JAFZA and Dubai Main Office</p>
                </div>
                <img src={section5CrescentPattern} className='absolute hidden lg:block' alt="" />
                <div className='flex flex-col items-center justify-center'>
                    <img className='w-full max-w-[1000px] lg:w-[65%] h-auto pt-6 lg:pt-10' src={section5pics} alt="" />
                </div>
            </section>            {/* sec6 */}
            <section className='pb-16 lg:pb-28 pt-12 lg:pt-20 flex flex-col px-4 lg:px-0 w-full'>
                <h1 className='text-xl lg:text-2xl xl:text-[2.2rem] p-6 lg:p-10 pb-12 lg:pb-20 font-bold text-center'><span className='text-[#CEB551]'>INDUSTRIES </span>WE ARE SERVING</h1>
                <div className='flex justify-center items-center gap-2 lg:gap-4 flex-wrap max-w-6xl mx-auto'>
                    <div className='relative mr-2 lg:mr-4 flex items-end justify-center text-lg lg:text-2xl pb-6 lg:pb-10 font-bold bg-contain bg-center bg-no-repeat h-[20rem] lg:h-[25rem] w-[16rem] lg:w-[20rem]'
                    ...
                    <div className='relative flex items-end justify-center text-sm lg:text-xl pb-6 lg:pb-10 bg-contain bg-center bg-no-repeat h-[20rem] lg:h-[25rem] w-[4rem] lg:w-[6rem]'
                    ...
                    <div
                        className='relative flex items-end justify-center text-sm lg:text-xl pb-6 lg:pb-10 bg-contain bg-center bg-no-repeat h-[20rem] lg:h-[25rem] w-[4rem] lg:w-[6rem]'
            ...
            </section>            {/* sec7 */}            <section className='relative bg-cover bg-center h-auto w-full pb-12 lg:pb-20 pt-12 lg:pt-20 flex flex-col justify-center items-center gap-6 lg:gap-10 px-4 lg:px-0'
                ...
                <h1 className='text-xl lg:text-2xl xl:text-4xl font-bold text-center'>Our <span className='bg-black px-2'>Impact</span> in Numbers</h1>
                <p className='mx-auto max-w-2xl text-center text-sm px-4'>Our outsourcing and manpower solutions have helped businesses in a wide range of industries to save time and money while reducing compliance risks.</p>
                <div className='flex flex-col lg:flex-row w-full max-w-6xl justify-evenly items-center content-center bg-[#2F2F2F] rounded-xl p-6 lg:p-8 pb-8 lg:pb-14 gap-6 lg:gap-4'>
                    <div className='w-full lg:w-60 h-auto text-center'>
                        <h1 className='font-semibold text-2xl lg:text-3xl xl:text-4xl'>20+</h1>
                        <p className='font-extralight text-sm p-2'>Industries</p>
                    </div>
                    <div className='w-full lg:w-60 h-auto text-center'>
                        <h1 className='font-semibold text-2xl lg:text-3xl xl:text-4xl'>1000+</h1>
                    ...
                    <div className='w-full lg:w-44 h-auto text-center'>
                        <h1 className='font-semibold text-2xl lg:text-3xl xl:text-4xl'>10+</h1>
